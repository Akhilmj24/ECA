...
export default function Login() {
  ...
  const handleLoginSubmit = (e) => {
    ...
    if (email.trim() === "") {
      ...
      postApi(data, apiPath.login).then((res) => {
        if (res.status) {
      ...
      <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
        <div className="mt-12 flex flex-col items-center">
          <div className="text-center">
            <h1 className="text-2xl xl:text-3xl font-medium">Login</h1>
            <small className="text-gray-500">
              Unlock a world of shopping with your account
            </small>
          </div>
            ...
            <div className="mx-auto max-w-xs">
              <form action="" onSubmit={(e) => handleLoginSubmit(e)}>
                ...
                <div className="text-center mt-5">
                  <button variant="contained" className="buttonCstm" type="submit">
                    Login
                  </button>
                </div>
              </form>
